...
def get_circle_scan(time_diffs, xs, ys, xy_pairs, ns_to_ps=False, radius=1, time_diff_lims=None, min_events=100, percentile_cuts=(None, None), nsigma_filter=None, plot=False):
    if ns_to_ps:
    ...
    for x, y in xy_pairs:
        ...
        fit_meases, hist_bin, bin_centers, hist_err = fit_time_diffs(time_diffs_bin, n_bins=100, min_events=min_events,
